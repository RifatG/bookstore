        ...
        var Profile = function () {
            ...
            return {
                init: function () {
                    ...
                    var profilePassError = false;
                    var profileConfirmPassError = false;
                    ...
                    var setError = function($this, isError, message) {
                        if (isError) {
                            $this.addClass('form-input_error');
                            if (!$this.next('.form-error').length) {
                                $this.after('<div class="form-error">'+ message +'</div>');
                    ...
                    var confirmPassCheck = function() {
                        ...
                        profileConfirmPassError = $this.val() !== $profilePassword.val();
                        setError($this, profileConfirmPassError, 'Пароль не подтверждён. Проверьте, что пароль и его подтверждение совпадают');
                        if (!profilePassError && !profileConfirmPassError) $saveButton.removeAttr('disabled');
                    }

                    $profilePassword.on('change', function() {
                        var $this = $(this);
                        $saveButton.attr('disabled', 'disabled');
                        profilePassError = $this.val().length < 6 && $this.val().length != 0 || $this.val().length > 12;
                        setError($this, profilePassError, 'Пароль должен состоять от 6 до 12 символов');
                        confirmPassCheck();
                    })
