            ...
            return {
                init: function () {
                    ...
                    $('.ProductCard-desc .book_description').click(function (event) {
                        showPopup(event, 'book_description', 'books/slug/description');
                    });

                    $('.ProductCard-desc .book_discount').click(function (event) {
                        showPopup(event, 'book_discount', 'books/slug/discount');
                    });

                    $('.ProductCard-desc .book_old_price').click(function (event) {
                        showPopup(event, 'book_old_price', 'books/slug/old_price');
                    });



                    const showPopup = function (event, popupId, endpoint) {
