...
(function ($) {
    ...
    $(function () {
                            ...
                            validate.forEach(function (v) {
                                switch (v) {
                                    ...
                                    case'key6':
                                        ...
                                        break;
                                    case'password':
                                        if ($this.val() !== '' && ($this.val().length < 6 || $this.val().length > 12) && !$this.prop('disabled')) {
                                            message += 'Пароль должен состоять от 6 до 12 символов';
                                            error = true;
                                        }
                                }
                            });
        ...
        var Login = function () {
            ...
            return {
                init: function () {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $this.trigger('change');
                                    $row.find('.form-input_mail, .form-input_phone').removeClass('form-input_error');
                                } else {
                                    if (result) {
                                        $this.val('');
                    ...
                    var $regButton = $('.Login_registration button[name="registration"]');
                    var $userName = $('.Login_registration input[name="name"]');
                    var $userMail = $('.Login_registration input[name="mail"]');
                    var $userPhone = $('.Login_registration input[name="phone"]');
                    var $userPassword = $('.Login_registration input[name="password"]');
                    ...
                    $regButton.on('click', function() {
                        ...
                        postData('/registration', data, function (result) {
                            if (result.result) {
                                $this.closest('.form-group').after('<div class="Profile-success" th:text="#{profile.profile-saved}">Пользователь успешно зарегистрирован!</div>')
                            } else {
                                $this.closest('.form-group').after('</div> <div class="form-error">' + result.error);
                            }
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error) {
                                var uri = '/requestContactConfirmation';
                                if ($this.data('type') === 'phone') uri = '/requestPhoneConfirmation';
                                postData(uri, $this.data('send'), function (result) {
                                    if (result.result) {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            ...
                            if (!error) {
                                var uri = '/login-by-phone-number';
                                var errorMessage = 'Confirmation code is not correct';
                                if ($this.attr('id')!='toComeInPhone') {
                                    uri = '/login-by-email';
                                ...
                                postData(uri, $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + errorMessage + '</div>');
                                        }
                                    }
                                })
                            }
        ...
        var AdminFeatures = function () {
            return {
                init: function () {
                    function postFormData(address, data, cb, cbErr) {
                       $.ajax({
                           url: address,
                           type: 'POST',
                           dataType: 'json',
                           ...
                           contentType: false,
                           complete: function (result) {
                               postDataResultHandler(result, cb, cbErr)
                           }
                       });
                    }
                    function postData(address, data, cb, cbErr) {
                    ...
                    let postDataResultHandler = function(result, cb, cbErr) {
                        if (result.status === 200) {
                            cb(result.responseJSON);
                        } else {
                            alert('Ошибка ' + result.status);
                    ...
                    $('.ProductCard-desc .book_title').click(function (event) {
                        showEditPopup(event, 'book_title');
                    });

                    $('.ProductCard-desc .book_description').click(function (event) {
                        showEditPopup(event, 'book_description');
                    });

                    $('.author_name').click(function (event) {
                        showEditPopup(event, 'author_name');
                    });

                    $('.Article .author_description').click(function (event) {
                        showEditPopup(event, 'author_description');
                    });

                    $('.ProductCard-desc .book_discount').click(function (event) {
                        showEditPopup(event, 'book_discount');
                    });

                    $('.ProductCard-desc .book_old_price').click(function (event) {
                        showEditPopup(event, 'book_old_price');
                    });

                    $('.ProductCard-desc .book_author').click(function (event) {
                        showEditPopup(event, 'book_author');
                    });

                    $('.Section .add_book_to_user').click(function (event) {
                        showEditPopup(event, 'add_book_to_user');
                    });

                    $('.Section .book_for_delete_from_user').click(function (event) {
                        showDeletePopup(event, 'book_for_delete_from_user');
                    });

                    $('.Comments .book_review').click(function (event) {
                        showDeletePopup(event, 'book_review');
                    });

                    $('.Product .book_for_delete').click(function (event) {
                        showDeletePopup(event, 'book_for_delete', '/');
                    });

                    $('.author_for_delete').click(function (event) {
                        showDeletePopup(event, 'author_for_delete', '/authors');
                    });

                    $('.create_new_author').click(function (event) {
                        showPopupFormData(event, 'create_new_author', ['name','description', 'photo']);
                    });

                    $('.create_new_book_for_author').click(function (event) {
                        showPopupFormData(event, 'create_new_book_for_author', ['title','description', 'image', 'price', 'discount']);
                    });

                    $('.create_new_book_in_main').click(function (event) {
                        showPopupFormData(event, 'create_new_book_in_main', ['title','description', 'image', 'price', 'discount', 'author']);
                    });

                    const showEditPopup = function (event, popupId, fields = null) {
                        popupId = '#myPopup__' + popupId;

                        const closePopup = function () {
                            $(popupId).animate({opacity: 1}, 198, function () {
                        ...
                        $('#myOverlay').fadeIn(297, function () {
                            $(popupId).css('display', 'block').animate({opacity: 1}, 198);
                        });

                        $('#myPopup__close, #myOverlay').on('click', closePopup);

                        $(popupId).find('#myPopup__save').on('click', function() {
                            var $this = $(this);
                            var data = {};
                            if (fields == null) {
                                data.value = $(popupId).find('#myPopup__input').val();
                            } else {
                                fields.forEach(field => data[`${field}`] = $(popupId).find(`#myPopup__input_${field}`).val());
                            }
                            postData($this.data('endpoint'), data, function (result) {
                                handleResult(result, $this, closePopup);
                            });

                        });
                    }

                    const showPopupFormData = function (event, popupId, fields) {
                        popupId = '#myPopup__' + popupId;
                        ...
                        $(popupId).find('#myPopup__save').on('click', function() {
                            ...
                            fields.forEach(field => {
                                let inputElement = $(popupId).find(`#myPopup__input_${field}`);
                                if (inputElement.attr('type') == 'file') {
                                    data.append(`${field}`,  inputElement[0].files[0]);
                                } else {
                                    data.append(`${field}`,  inputElement.val());
                                }
                            });
                            postFormData($this.data('endpoint'), data, function (result) {
                                handleResult(result, $this, closePopup);
                            });
                    ...
                    const showDeletePopup = function (event, popupId, redirect = null) {
                        popupId = '#myPopup__' + popupId;
                        ...
                        $(popupId).find('#myPopup__save').on('click', function() {
                            ...
                            postData($this.data('endpoint'), data, function (result) {
                                handleResult(result, $this, closePopup, redirect);
                            });
                        });
                    }

                    let handleResult = function(result, $this, closePopup, redirect) {
                        if (result.result) {
                            closePopup();
                            if(redirect == null) {
                                document.location.reload(false);
                    ...
                    $('.user-search-button').on('click', function (e) {
                        ...
                        getData('/users/search/' + $('.user-search-input').val(), {});
                    });
        ...
        var Profile = function () {
            ...
            return {
                init: function () {
                    ...
                    var $profilePassword = $('.Profile input[name="password"]');
                    var $profilePasswordReply = $('.Profile input[name="passwordReply"]');
                    var $saveButton = $('.Profile button[type="submit"]');
                    var mailApproved = true;
                    var phoneApproved = true;
                    var $profileName = $('.Profile input[name="name"]');
                    var $profileMail = $('.Profile input[name="mail"]');
                    var $profilePhone = $('.Profile input[name="phone"]');
                    var currentMail = $profileMail.val();
                    var currentPhone = $profilePhone.val();
                    var profileErrors = new Set();
                    function postData(address, data, cb, cbErr) {
                        // var token = $('#_csrf').attr('content');
                        // var header = $('#_csrf_header').attr('content');
                        $.ajax({
                    ...
                    $saveButton.on('click', function() {
                        ...
                        postData('/profile', data, function (result) {
                            if (result.result) {
                                $this.closest('.Profile-btn').after('<div class="Profile-success" th:text="#{profile.profile-saved}">Профиль успешно сохранен</div>')
                            } else {
                                $this.closest('.Profile-btn').after('</div> <div class="form-error">' + result.error);
                            }
                        })
                    })

                    $profileMail.on('change', function () {
                        var $this = $(this);
                        $saveButton.attr('disabled', 'disabled');
                        $this.next('.Profile-btn_confirm').show(0);
                        $this.next('.form-input_code').show(0);
                        mailApproved = $this.val() === currentMail;
                        enableSaveButton();
                        if (mailApproved) {
                            $this.next('.Profile-btn_confirm').hide(0);
                            $this.next('.form-input_code').hide(0);
                        }
                    });

                    $profilePhone.on('change', function () {
                        var $this = $(this);
                        $saveButton.attr('disabled', 'disabled');
                        $this.next('.Profile-btn_confirm').show(0);
                        $this.next('.form-input_code').show(0);
                        phoneApproved = $this.val() === currentPhone;
                        enableSaveButton();
                        if (phoneApproved) {
                            $this.next('.Profile-btn_confirm').hide(0);
                            $this.next('.form-input_code').hide(0);
                    ...
                    $('.profile-btn_mail_confirm').on('click', function () {
                    ...
                    $('.profile-btn_phone_confirm').on('click', function () {
                        var $this = $(this), $row = $this.closest('.form-group'),
                            data = {contact: $row.find('.form-input_phone').val()};
                        postData('/requestPhoneConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">Вам позвонят. Код - последние 4 цифры</div>')
                                $this.attr('disabled', 'disabled');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                            } else {
                    ...
                    $('.Profile .form-input_code').on('blur', function () {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    $this.attr('disabled', 'disabled');
                                    $but.attr('disabled', 'disabled');
                                    $this.after('<div class="form-info">Код успешно подтвержден</div>');
                                    if ($this.attr('name') === "phoneCode") phoneApproved = true;
                                    if ($this.attr('name') === "mailCode") mailApproved = true;
                                    $row.find('.form-input_mail, .form-input_phone').removeClass('form-input_error');
                                    enableSaveButton();
                                } else {
                                    if (result) {
                    ...
                    var setError = function($this, isError, errorKey, message) {
                        if (isError) {
                            $this.addClass('form-input_error');
                            if (!$this.next('.form-error').length) {
                                $this.after('<div class="form-error">'+ message +'</div>');
                            ...
                            $this.data('errorinput', true);
                            profileErrors.add(errorKey)
                        } else {
                            $this.next('.form-error').remove();
                            $this.removeClass('form-input_error');
                            $this.data('errorinput', false);
                            profileErrors.delete(errorKey)
                        }
                    }
                    $profileName.on('change', function() {
                        var $this = $(this);
                        $saveButton.attr('disabled', 'disabled');
                        setError($this, $this.val().length < 2, 'nameError', 'Имя должно сожержать как минимум 2 символа');
                        enableSaveButton();
                    })

                    var enableSaveButton = function() {
                        if (profileErrors.size === 0 && mailApproved && phoneApproved) {
                            $saveButton.removeAttr('disabled');
                        }
                    }

                    var confirmPassCheck = function() {
                        var $this = $profilePasswordReply;
                        $saveButton.attr('disabled', 'disabled');
                        setError($this, $this.val() !== $profilePassword.val(), 'passConfirmError', 'Пароль не подтверждён. Проверьте, что пароль и его подтверждение совпадают');
                        enableSaveButton();
                    }

                    $profilePassword.on('change', function() {
                        var $this = $(this);
                        $saveButton.attr('disabled', 'disabled');
                        var error = $this.val().length < 6 && $this.val().length != 0 || $this.val().length > 12;
                        setError($this, error, 'passError', 'Пароль должен состоять от 6 до 12 символов');
                        confirmPassCheck();
                    })

                    $profilePasswordReply.on('change', confirmPassCheck);
        ...
        var Feedback = function() {
            return {
                init: function() {
                    ...
                    const senderName = $('.Contacts input[name="name"]');
                    const senderMail = $('.Contacts input[name="mail"]');
                    const feedbackSubject = $('.Contacts input[name="topic"]');
                    const feedbackText = $('.Contacts textarea[name="message"]');
                    const feedbackSubmit = $('.Contacts button[type="submit"]');
                    var feedbackErrors = new Set();
                    feedbackErrors.add("nameError");
                    feedbackErrors.add("mailError");
                    feedbackErrors.add("subjectError");
                    feedbackErrors.add("textError");

                    senderName.on('change', function() {
                        feedbackFieldsCheck($(this).val().length < 1, "nameError");
                    });

                    senderMail.on("change", function() {
                        var $this = $(this);
                        feedbackFieldsCheck($this.val() !== '' && !$this.val().match(/\w+@\w+\.\w+/), "mailError");
                    })

                    feedbackSubject.on('change', function() {
                        feedbackFieldsCheck($(this).val().length < 1, "subjectError");
                    });

                    feedbackText.on('change', function() {
                        feedbackFieldsCheck($(this).val().length < 1, "textError");
                    });

                    var feedbackFieldsCheck = function(validation, errorKey) {
                        feedbackSubmit.attr("disabled", "disabled");
                        if (validation) feedbackErrors.add(errorKey);
                        else feedbackErrors.delete(errorKey);
                        if(feedbackErrors.size === 0) feedbackSubmit.removeAttr('disabled');
                    }
                    ...
                    feedbackSubmit.on('click', function() {
                        ...
                        postData('/contacts', data, function (result) {
                            if (result.result) {
                                $this.closest('.form-group').after('<div class="Profile-success" th:text="#{profile.profile-saved}">Ваше сообщение успешно отправлено</div>')
                            } else {
                                $this.closest('.form-group').after('</div> <div class="form-error">' + result.error);
                            }
                        })
